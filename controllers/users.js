...
// Хорошей практикой является обработка всех ошибок в блоке .catch,
// поэтому проверку наличия пользователя и карточки лучше проверить
// через orFail(). Вот хороший видео обзор,
// пожалуйста просмотрите видео https://www.youtube.com/watch?v=1cIPE4GoMnE.
